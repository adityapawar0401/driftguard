import type { Actor, ActorRole, MemoryLayer, TrustLevel, WriterType } from "./types.js";

const writerByRole: Record<ActorRole, WriterType> = {
...
export function requireRole(actor: Actor | undefined, allowed: ActorRole[], action: string): Actor {
...
export function writerTypeFor(actor: Actor): WriterType {
